...
// src/constants.ts
var VIEW_TYPE_MIX_CALENDAR, GRANULARITIES, DOW_ABBR, DOW_ABBR_EN, TASK_REGEX, COMPLETED_TASK_REGEX, DEFAULT_SETTINGS, I18N;
var init_constants = __esm({
  "src/constants.ts"() {
    "use strict";
    VIEW_TYPE_MIX_CALENDAR = "mix-calendar-view";
    GRANULARITIES = ["daily", "weekly", "monthly", "quarterly", "yearly"];
    DOW_ABBR = ["\u65E5", "\u4E00", "\u4E8C", "\u4E09", "\u56DB", "\u4E94", "\u516D"];
    DOW_ABBR_EN = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
    TASK_REGEX = /- \[[ xX]\]\s*\S/g;
    COMPLETED_TASK_REGEX = /- \[[xX]\]\s*\S/g;
    DEFAULT_SETTINGS = {
      weekStart: "locale",
...
// src/calendar/stores.ts
function createNoteIndexStore(granularity) {
  ...
  return {
    ...
    has(dateUID) {
      return !!get_store_value({ subscribe: subscribe2 }).notes[dateUID];
    },
    ...
    getTaskStats(dateUID) {
      return get_store_value({ subscribe: subscribe2 }).taskStats[dateUID];
    },
    /** Get backlink count for a specific dateUID */
    getLinkCount(dateUID) {
      return get_store_value({ subscribe: subscribe2 }).linkCounts[dateUID] ?? 0;
    }
  };
}
var settings, currentDate, viewMode, activeFile, selectedDateUID, isIndexing, indexError, dailyNotes, weeklyNotes, monthlyNotes, quarterlyNotes, yearlyNotes, noteStores, showWeekNumbers, weekStartDay, uiLocale, i18n;
var init_stores = __esm({
  "src/calendar/stores.ts"() {
    "use strict";
    init_store();
    init_constants();
    settings = writable(DEFAULT_SETTINGS);
    currentDate = writable(window.moment());
    viewMode = writable("month");
    activeFile = writable(null);
    selectedDateUID = writable(null);
    isIndexing = writable(false);
    indexError = writable(null);
    dailyNotes = createNoteIndexStore("daily");
    weeklyNotes = createNoteIndexStore("weekly");
    monthlyNotes = createNoteIndexStore("monthly");
    quarterlyNotes = createNoteIndexStore("quarterly");
    yearlyNotes = createNoteIndexStore("yearly");
    noteStores = {
      daily: dailyNotes,
      weekly: weeklyNotes,
    ...
    showWeekNumbers = derived(
      [settings, viewMode],
      ([$settings, $viewMode]) => {
        return $viewMode === "month" && $settings.showWeekNumbers;
      }
    );
    weekStartDay = derived(settings, ($settings) => {
      const ws = $settings.weekStart;
      if (ws === "locale") {
        const locale = $settings.localeOverride !== "system-default" ? $settings.localeOverride : window.moment.locale();
    ...
    uiLocale = derived(settings, ($settings) => {
      return $settings.uiLocale || "zh";
    });
    i18n = derived(uiLocale, ($locale) => {
      return I18N[$locale];
    });
  }
});
...
var _SolarUtil, SolarUtil, SolarWeek, _LunarUtil, LunarUtil, Holiday, _HolidayUtil, HolidayUtil, JieQi, LiuYue, TaoFestival, TaoUtil, FotoFestival, _FotoUtil, FotoUtil, NineStarUtil, _I18n, I18n, LiuNian, XiaoYun, DaYun, Yun, EightChar, _NineStar, NineStar, ShuJiu, Fu, LunarMonth, _ShouXingUtil, ShouXingUtil, _LunarYear, LunarYear, LunarTime, _Foto, Foto, _Tao, Tao, Lunar, SolarMonth, _Solar, Solar;
var init_dist = __esm({
  "node_modules/lunar-typescript/dist/index.mjs"() {
    _SolarUtil = class {
    ...
    _HolidayUtil = class {
      ...
      static _fixData(data) {
        ...
        if (append2.length > 0) {
          _HolidayUtil._DATA_IN_USE += append2.join("");
        }
      }
      static fix(a, b) {
        if (!b) {
...
// src/lunar/formatter.ts
function getDisplayText(lunarFestivals, solarFestivals, jieQi, lunarDayChinese, lunarMonthChinese) {
...
// src/lunar/converter.ts
function getLunarInfo(year, month, day, holidayOverrides = {}) {
  try {
    ...
    let { text: text2, type } = getDisplayText(
      allFestivals,
      solarFestivals,
      jieQi,
...
function getGanZhiYearLabel(year, month, day) {
  try {
    const solar = Solar.fromYmd(year, month, day);
    const lunar = solar.getLunar();
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "mix-calendar-chinese-label");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(button0, "class", "mix-calendar-nav-btn");
      attr(
        button0,
        "title",
        /*prevTitle*/
      ...
      attr(div0, "class", "mix-calendar-nav");
      attr(span, "class", "mix-calendar-title");
      attr(span, "role", "button");
      attr(span, "tabindex", "0");
      attr(button1, "class", "mix-calendar-today-btn");
      attr(
        button1,
        "title",
        /*todayTitle*/
      ...
      attr(div1, "class", "mix-calendar-center");
      attr(button2, "class", "mix-calendar-view-btn");
      toggle_class(
        button2,
        "active",
        /*$viewMode*/
      ...
      attr(button3, "class", "mix-calendar-view-btn");
      toggle_class(
        button3,
        "active",
        /*$viewMode*/
      ...
      attr(div2, "class", "mix-calendar-view-toggle");
      attr(button4, "class", "mix-calendar-nav-btn");
      attr(
        button4,
        "title",
        /*nextTitle*/
      ...
      attr(div3, "class", "mix-calendar-nav");
      attr(div4, "class", "mix-calendar-header");
    },
    m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let $settings;
  let $i18n;
  component_subscribe($$self, viewMode, ($$value) => $$invalidate(0, $viewMode = $$value));
  component_subscribe($$self, currentDate, ($$value) => $$invalidate(13, $currentDate = $$value));
  component_subscribe($$self, uiLocale, ($$value) => $$invalidate(14, $uiLocale = $$value));
  ...
  function goPrev() {
    if ($viewMode === "month") {
      set_store_value(currentDate, $currentDate = $currentDate.clone().subtract(1, "month"), $currentDate);
    } else {
      set_store_value(currentDate, $currentDate = $currentDate.clone().subtract(1, "year"), $currentDate);
    }
  }
  function goNext() {
    if ($viewMode === "month") {
      set_store_value(currentDate, $currentDate = $currentDate.clone().add(1, "month"), $currentDate);
    } else {
      set_store_value(currentDate, $currentDate = $currentDate.clone().add(1, "year"), $currentDate);
    }
  }
  function goToday() {
    set_store_value(currentDate, $currentDate = window.moment(), $currentDate);
  }
  function setViewMode(mode) {
    set_store_value(viewMode, $viewMode = mode, $viewMode);
  }
  const click_handler = () => setViewMode("month");
  const click_handler_1 = () => setViewMode("year");
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*$currentDate*/
    8192) {
      $: {
        if ($currentDate) {
          $$invalidate(11, internalDate = $currentDate.clone());
        }
      }
    }
    if ($$self.$$.dirty & /*$viewMode, internalDate, $i18n*/
    2051) {
      $:
        $$invalidate(6, titleText = $viewMode === "month" ? internalDate.format($i18n.monthFormat) : internalDate.format($i18n.yearFormat));
    }
    if ($$self.$$.dirty & /*$settings, internalDate*/
    34816) {
      $:
        $$invalidate(5, ganZhiLabel = $settings.showLunarInfo ? getGanZhiYearLabel(internalDate.year(), internalDate.month() + 1, 1) : "");
    }
    if ($$self.$$.dirty & /*$uiLocale*/
    16384) {
      $:
        $$invalidate(12, isZh = $uiLocale === "zh");
    }
    if ($$self.$$.dirty & /*$viewMode, isZh*/
    4097) {
      $:
        $$invalidate(4, prevTitle = $viewMode === "month" ? isZh ? "\u4E0A\u4E00\u4E2A\u6708" : "Previous Month" : isZh ? "\u4E0A\u4E00\u5E74" : "Previous Year");
    }
    if ($$self.$$.dirty & /*$viewMode, isZh*/
    4097) {
      $:
        $$invalidate(3, nextTitle = $viewMode === "month" ? isZh ? "\u4E0B\u4E00\u4E2A\u6708" : "Next Month" : isZh ? "\u4E0B\u4E00\u5E74" : "Next Year");
    }
    if ($$self.$$.dirty & /*isZh*/
    4096) {
      $:
        $$invalidate(2, todayTitle = isZh ? "\u56DE\u5230\u4ECA\u5929" : "Go to Today");
    }
  };
  return [
    $viewMode,
...
var init_Header = __esm({
  "src/calendar/Header.svelte"() {
    ...
    init_stores();
    init_converter();
    Header = class extends SvelteComponent {
      constructor(options) {
        super();
...
// src/notes/creator.ts
async function createPeriodicNote(app, date, granularity, settings2, holidayOverrides = {}) {
  if (!settings2.enabled) {
    console.warn(`[Mix Calendar] ${granularity} notes are disabled`);
    return null;
  }
  const notePath = getNotePath(date, settings2);
  if (!notePath)
    return null;
  ...
  const content = await buildNoteContent(app, date, granularity, settings2, holidayOverrides);
...
function getNotePath(date, settings2) {
  const name = date.format(settings2.format);
  const folder = settings2.folder ? settings2.folder.replace(/\/$/, "") : "";
  const fileName = folder ? `${folder}/${name}.md` : `${name}.md`;
  return fileName;
}
async function buildNoteContent(app, date, granularity, settings2, holidayOverrides = {}) {
  let templateContent = "";
  if (settings2.template) {
    try {
      const templatePath = settings2.template.endsWith(".md") ? settings2.template : settings2.template + ".md";
      ...
      console.warn(
        `[Mix Calendar] Template not found: ${settings2.template}`
      );
    }
  }
  ...
  for (let i = 0; i < 7; i++) {
    ...
    content = content.replace(regex, (_match, fmt) => {
...
function buildTemplateVars(date, granularity, holidayOverrides = {}) {
  const vars = {
...
var import_obsidian2, ConfirmCreateModal;
var init_ConfirmModal = __esm({
  "src/ui/ConfirmModal.ts"() {
    "use strict";
    import_obsidian2 = require("obsidian");
    ConfirmCreateModal = class extends import_obsidian2.Modal {
      constructor(app, notePath, noteType, onConfirm) {
        super(app);
...
// src/ui/fileMenu.ts
var fileMenu_exports = {};
__export(fileMenu_exports, {
  showNoteContextMenu: () => showNoteContextMenu
});
function showNoteContextMenu(event, app, file, granularity, dateLabel) {
  if (!file)
    return;
  const menu = new import_obsidian3.Menu();
  menu.addItem((item) => {
    item.setTitle(`\u6253\u5F00${getGranLabel(granularity)}`).setIcon("file-text").onClick(() => {
      app.workspace.getLeaf(false).openFile(file);
    });
  });
  menu.addItem((item) => {
    item.setTitle("\u5728\u6587\u4EF6\u6D4F\u89C8\u5668\u4E2D\u663E\u793A").setIcon("folder").onClick(() => {
...
function create_if_block_8(ctx) {
  ...
  return {
    c() {
      span = element("span");
      t = text(t_value);
      attr(span, "class", span_class_value = "lunar-text " + /*data*/
      ctx[0].lunar.displayType);
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[0].lunar.displayText + ""))
        set_data(t, t_value);
      if (dirty & /*data*/
      1 && span_class_value !== (span_class_value = "lunar-text " + /*data*/
      ctx2[0].lunar.displayType)) {
...
function create_if_block_5(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    if (
      /*data*/
      ctx2[0].lunar?.isHoliday
    )
      return create_if_block_6;
    if (
      /*data*/
      ctx2[0].lunar?.isWorkday
    )
...
function create_if_block_7(ctx) {
  ...
  return {
    c() {
      span = element("span");
      span.textContent = "\u73ED";
      attr(span, "class", "holiday-badge workday");
    },
    m(target, anchor) {
      insert(target, span, anchor);
    },
...
function create_if_block_6(ctx) {
  ...
  return {
    c() {
      span = element("span");
      span.textContent = "\u4F11";
      attr(span, "class", "holiday-badge holiday");
    },
    m(target, anchor) {
      insert(target, span, anchor);
    },
...
function create_if_block_4(ctx) {
  ...
  return {
    c() {
      div = element("div");
      div.innerHTML = `<span class="mix-calendar-dot" title="\u6709\u65E5\u8BB0\uFF08\u70B9\u51FB\u6253\u5F00\uFF09"></span>`;
      attr(div, "class", "mix-calendar-dots");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_if_block_2(ctx) {
  ...
  return {
    c() {
      div = element("div");
      if_block.c();
      attr(div, "class", "mix-calendar-task-dots");
      attr(
        div,
        "title",
        /*taskTooltip*/
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(span0, "class", "mix-calendar-task-dot incomplete");
      attr(span1, "class", "task-incomplete-badge");
    },
    m(target, anchor) {
...
function create_if_block_3(ctx) {
  ...
  return {
    c() {
      ...
      span1 = element("span");
      span1.textContent = "\u2713";
      attr(span0, "class", "mix-calendar-task-dot complete");
      attr(span1, "class", "task-complete-badge");
    },
    m(target, anchor) {
      insert(target, span0, anchor);
      insert(target, t0, anchor);
...
function create_if_block2(ctx) {
  ...
  return {
    c() {
      ...
      if (if_block)
        if_block.c();
      attr(div, "class", "mix-calendar-link-dots");
      attr(
        div,
        "title",
        /*linkTooltip*/
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      span = element("span");
      attr(span, "class", "mix-calendar-link-dot");
    },
    m(target, anchor) {
      insert(target, span, anchor);
    },
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(span, "class", "mix-calendar-link-overflow");
    },
    m(target, anchor) {
      insert(target, span, anchor);
      append(span, t0);
...
function create_fragment2(ctx) {
  ...
  let if_block0 = (
    /*data*/
    ctx[0].lunar && create_if_block_8(ctx)
  );
  let if_block1 = (
    /*plugin*/
    ctx[1].settings.showHolidayBadges && create_if_block_5(ctx)
  );
  ...
  return {
    c() {
      ...
      attr(div, "role", "button");
      attr(div, "tabindex", "0");
      attr(div, "title", div_title_value = /*data*/
      ctx[0].hasNote ? "\u70B9\u51FB\u6253\u5F00\u65E5\u8BB0 | Ctrl+Click \u65B0\u5206\u680F | Ctrl+Hover \u9884\u89C8" : "\u70B9\u51FB\u521B\u5EFA\u65E5\u8BB0 | Ctrl+Click \u65B0\u5206\u680F");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, span);
    ...
    p(ctx2, [dirty]) {
      ...
      if (
        /*plugin*/
        ctx2[1].settings.showHolidayBadges
      ) {
        if (if_block1) {
      ...
      if (dirty & /*data*/
      1 && div_title_value !== (div_title_value = /*data*/
      ctx2[0].hasNote ? "\u70B9\u51FB\u6253\u5F00\u65E5\u8BB0 | Ctrl+Click \u65B0\u5206\u680F | Ctrl+Hover \u9884\u89C8" : "\u70B9\u51FB\u521B\u5EFA\u65E5\u8BB0 | Ctrl+Click \u65B0\u5206\u680F")) {
...
function instance2($$self, $$props, $$invalidate) {
  ...
  function handlePointerOver(e) {
    if (!isModPressed(e))
      return;
    const note = get_store_value(dailyNotes).notes[data.dateUID];
    const notePath = note?.path;
    plugin.app.workspace.trigger("link-hover", {}, e.currentTarget, data.date.format(plugin.settings.daily.format), notePath);
  }
  async function handleClick(e) {
    ...
    const existing = get_store_value(dailyNotes).notes[dateUID];
    if (existing) {
    ...
    const doCreate = async () => {
      const file = await createPeriodicNote(plugin.app, data.date, "daily", granSettings, plugin.settings.holidayOverrides);
      if (file) {
  ...
  function handleContextMenu(e) {
    ...
    if (existing) {
      e.preventDefault();
      Promise.resolve().then(() => (init_fileMenu(), fileMenu_exports)).then(({ showNoteContextMenu: showNoteContextMenu2 }) => {
        showNoteContextMenu2(e, plugin.app, existing, "daily", data.dateUID);
      });
    }
  }
  async function handleDotClick(e) {
    e.stopPropagation();
    ...
    if (view?.editor) {
      ...
      const lineIndex = lines.findIndex((l) => /- \[ \]\s*\S/.test(l));
      if (lineIndex >= 0) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*data, plugin*/
    3) {
      $: {
        const classes = ["mix-calendar-day"];
        ...
        if (data.isPast && plugin.settings.pastTimeTransparent)
          classes.push("is-past");
        $$invalidate(4, cellClasses = classes.join(" "));
      }
    }
    if ($$self.$$.dirty & /*data*/
    1) {
      $:
        $$invalidate(16, stats = data.taskStats);
    }
    if ($$self.$$.dirty & /*plugin, stats*/
    65538) {
      $:
        $$invalidate(3, showTaskDot = plugin.settings.showTaskIndicators && stats !== null && stats.total > 0);
    }
    if ($$self.$$.dirty & /*showTaskDot, stats*/
    65544) {
      $:
        $$invalidate(10, isTaskComplete = showTaskDot && stats !== null && stats.completed === stats.total);
    }
    if ($$self.$$.dirty & /*stats*/
    65536) {
      $:
        $$invalidate(9, incompleteCount = stats && stats.total > stats.completed ? stats.total - stats.completed : 0);
    }
    if ($$self.$$.dirty & /*showTaskDot, stats*/
    65544) {
      $:
        $$invalidate(8, taskTooltip = showTaskDot && stats !== null ? `${stats.completed}/${stats.total} \u4EFB\u52A1\u5B8C\u6210` : "");
    }
    if ($$self.$$.dirty & /*data*/
    1) {
      $:
        $$invalidate(15, linkCountVal = data.linkCount ?? 0);
    }
    if ($$self.$$.dirty & /*plugin, linkCountVal*/
    32770) {
      $:
        $$invalidate(2, showLinkDots = plugin.settings.showLinkCount && linkCountVal > 0);
    }
    if ($$self.$$.dirty & /*showLinkDots, linkCountVal*/
    32772) {
      $:
        $$invalidate(7, linkTooltip = showLinkDots ? `${linkCountVal} \u4E2A\u53CD\u5411\u94FE\u63A5` : "");
    }
    if ($$self.$$.dirty & /*linkCountVal*/
    32768) {
      $:
        $$invalidate(6, maxLinkDots = Math.min(linkCountVal, 5));
    }
    if ($$self.$$.dirty & /*linkCountVal*/
    32768) {
      $:
        $$invalidate(5, linkOverflow = linkCountVal > 5 ? linkCountVal - 5 : 0);
    }
  };
  return [
    data,
...
var init_DayCell = __esm({
  "src/calendar/DayCell.svelte"() {
    ...
    init_store();
    init_stores();
    DayCell = class extends SvelteComponent {
      constructor(options) {
        super();
        init(this, options, instance2, create_fragment2, safe_not_equal, { data: 0, plugin: 1 });
      }
    };
    DayCell_default = DayCell;
  }
});

// src/calendar/WeekNumCell.svelte
...
function create_if_block_12(ctx) {
  ...
  return {
    c() {
      span = element("span");
      attr(span, "class", "mix-calendar-dot weeknum-dot");
    },
    m(target, anchor) {
      insert(target, span, anchor);
    },
...
function create_if_block3(ctx) {
  ...
  return {
    c() {
      ...
      t1 = text("/");
      t2 = text(t2_value);
      attr(span, "class", "weeknum-task-count");
      toggle_class(
        span,
        "complete",
        /*isComplete*/
      ...
      toggle_class(span, "incomplete", !/*isComplete*/
      ctx[5]);
    },
    m(target, anchor) {
      insert(target, span, anchor);
...
function create_fragment3(ctx) {
  ...
  let if_block0 = (
    /*weekNum*/
    ctx[0] !== null && create_if_block_22(ctx)
  );
  function select_block_type(ctx2, dirty) {
    if (
      /*showCount*/
  ...
  return {
    c() {
      ...
      if (if_block1)
        if_block1.c();
      attr(div, "class", "mix-calendar-weeknum");
      attr(div, "role", "button");
      attr(div, "tabindex", "0");
      attr(
        div,
...
function isModPressed2(e) {
  return isMacOS2() ? e.metaKey : e.ctrlKey;
}
function instance3($$self, $$props, $$invalidate) {
  ...
  let { weekNum } = $$props;
  let { weekUID = "" } = $$props;
  let { weekDate = null } = $$props;
  let { hasWeeklyNote = false } = $$props;
  let { weeklyTaskStats = null } = $$props;
  let { plugin } = $$props;
  function handlePointerOver(e) {
    if (!isModPressed2(e))
      return;
    if (!weekDate)
      return;
    const note = get_store_value(weeklyNotes).notes[weekUID];
    plugin.app.workspace.trigger("link-hover", {}, e.currentTarget, `W${weekNum}`, note?.path);
  }
  async function handleClick(e) {
    if (weekNum === null || !weekDate)
      return;
    const granSettings = plugin.settings.weekly;
    if (!granSettings.enabled)
      return;
    const useNewLeaf = isModPressed2(e);
    const existing = get_store_value(weeklyNotes).notes[weekUID];
    if (existing) {
      plugin.app.workspace.getLeaf(useNewLeaf ? "split" : false).openFile(existing);
      return;
    }
    ...
    const doCreate = async () => {
      const file = await createPeriodicNote(plugin.app, weekDate, "weekly", granSettings, plugin.settings.holidayOverrides);
      if (file) {
        plugin.app.workspace.getLeaf(useNewLeaf ? "split" : false).openFile(file);
      }
    };
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("weekUID" in $$props2)
      $$invalidate(8, weekUID = $$props2.weekUID);
    if ("weekDate" in $$props2)
      $$invalidate(9, weekDate = $$props2.weekDate);
    if ("hasWeeklyNote" in $$props2)
      $$invalidate(1, hasWeeklyNote = $$props2.hasWeeklyNote);
    if ("weeklyTaskStats" in $$props2)
      $$invalidate(10, weeklyTaskStats = $$props2.weeklyTaskStats);
    if ("plugin" in $$props2)
      $$invalidate(11, plugin = $$props2.plugin);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*weeklyTaskStats*/
    1024) {
      $:
        $$invalidate(2, stats = weeklyTaskStats);
    }
    if ($$self.$$.dirty & /*plugin, stats*/
    2052) {
      $:
        $$invalidate(3, showCount = plugin.settings.showTaskIndicators && stats !== null && stats.total > 0);
    }
    if ($$self.$$.dirty & /*showCount, stats*/
    12) {
      $:
        $$invalidate(5, isComplete = showCount && stats !== null && stats.completed === stats.total);
    }
    if ($$self.$$.dirty & /*showCount, stats, hasWeeklyNote, weekNum*/
    15) {
      $:
        $$invalidate(4, tooltip = showCount && stats !== null ? `${stats.completed}/${stats.total} \u4EFB\u52A1\u5B8C\u6210` : hasWeeklyNote ? "\u6709\u5468\u8BB0\uFF08\u70B9\u51FB\u6253\u5F00\uFF09" : weekNum !== null ? `W${weekNum}\uFF08\u70B9\u51FB\u521B\u5EFA\u5468\u8BB0\uFF09` : "");
    }
  };
  return [
    weekNum,
...
var WeekNumCell, WeekNumCell_default;
var init_WeekNumCell = __esm({
  "src/calendar/WeekNumCell.svelte"() {
    "use strict";
    init_internal();
    init_disclose_version();
    ...
    init_stores();
    init_store();
    WeekNumCell = class extends SvelteComponent {
      constructor(options) {
        super();
    ...
    WeekNumCell_default = WeekNumCell;
  }
});

// src/calendar/MonthView.svelte
...
function create_if_block_13(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "mix-calendar-dow-cell");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_if_block4(ctx) {
  let weeknumcell;
  let current;
  weeknumcell = new WeekNumCell_default({
    props: {
      weekNum: (
        /*week*/
        ctx[15].weekNum
      ...
      hasWeeklyNote: (
        /*week*/
        ctx[15].hasWeeklyNote
      ),
      weeklyTaskStats: (
        /*week*/
        ctx[15].weeklyTaskStats
      ),
      plugin: (
        /*plugin*/
        ctx[0]
  ...
  return {
    c() {
      create_component(weeknumcell.$$.fragment);
    },
    m(target, anchor) {
      mount_component(weeknumcell, target, anchor);
      current = true;
    },
    p(ctx2, dirty) {
      const weeknumcell_changes = {};
      if (dirty & /*weeks*/
      4)
        weeknumcell_changes.weekNum = /*week*/
        ctx2[15].weekNum;
      if (dirty & /*weeks*/
      4)
        weeknumcell_changes.weekUID = /*week*/
        ctx2[15].weekUID;
      if (dirty & /*weeks*/
      4)
        weeknumcell_changes.weekDate = /*week*/
        ctx2[15].weekDate;
      if (dirty & /*weeks*/
      4)
        weeknumcell_changes.hasWeeklyNote = /*week*/
        ctx2[15].hasWeeklyNote;
      if (dirty & /*weeks*/
      4)
        weeknumcell_changes.weeklyTaskStats = /*week*/
        ctx2[15].weeklyTaskStats;
      if (dirty & /*plugin*/
      1)
        weeknumcell_changes.plugin = /*plugin*/
        ctx2[0];
      weeknumcell.$set(weeknumcell_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(weeknumcell.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(weeknumcell.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(weeknumcell, detaching);
    }
  };
}
function create_each_block_1(ctx) {
  ...
  return {
    c() {
      create_component(daycell.$$.fragment);
    },
    m(target, anchor) {
      mount_component(daycell, target, anchor);
      current = true;
    },
    p(ctx2, dirty) {
      const daycell_changes = {};
      if (dirty & /*weeks*/
      4)
        daycell_changes.data = /*dayData*/
        ctx2[18];
      if (dirty & /*plugin*/
      1)
        daycell_changes.plugin = /*plugin*/
        ctx2[0];
      daycell.$set(daycell_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(daycell.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(daycell.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(daycell, detaching);
    }
  };
}
function create_each_block2(ctx) {
  ...
  return {
    c() {
      ...
      t1 = space();
      attr(div, "class", "mix-calendar-week-row");
      toggle_class(div, "no-weeknum", !/*$showWeekNumbers*/
      ctx[1]);
    },
    m(target, anchor) {
      insert(target, div, anchor);
    ...
    p(ctx2, dirty) {
      ...
      if (!current || dirty & /*$showWeekNumbers*/
      2) {
        toggle_class(div, "no-weeknum", !/*$showWeekNumbers*/
        ctx2[1]);
      }
...
function create_fragment4(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "mix-calendar-dow-header");
      toggle_class(div0, "no-weeknum", !/*$showWeekNumbers*/
      ctx[1]);
      attr(div1, "class", "mix-calendar-month-grid");
    },
    m(target, anchor) {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*$showWeekNumbers, weeks, plugin*/
      7) {
...
function instance4($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, showWeekNumbers, ($$value) => $$invalidate(1, $showWeekNumbers = $$value));
  component_subscribe($$self, weekStartDay, ($$value) => $$invalidate(5, $weekStartDay = $$value));
  component_subscribe($$self, selectedDateUID, ($$value) => $$invalidate(6, $selectedDateUID = $$value));
  component_subscribe($$self, settings, ($$value) => $$invalidate(7, $settings = $$value));
  component_subscribe($$self, weeklyNotes, ($$value) => $$invalidate(8, $weeklyNotes = $$value));
  component_subscribe($$self, dailyNotes, ($$value) => $$invalidate(9, $dailyNotes = $$value));
  component_subscribe($$self, viewMode, ($$value) => $$invalidate(10, $viewMode = $$value));
  component_subscribe($$self, currentDate, ($$value) => $$invalidate(11, $currentDate = $$value));
  let { plugin } = $$props;
  let weeks = [];
  let dowLabels = [];
  function buildDowLabels(wsd, showWN) {
    const labels = [];
    ...
    $$invalidate(3, dowLabels = labels);
  }
  function buildMonthGrid(date, wsd, mode, showWN, dailyNoteData, weeklyNoteData, pluginSettings, selUID) {
    if (!date)
      return;
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*$currentDate, $weekStartDay, $viewMode, $showWeekNumbers, $dailyNotes, $weeklyNotes, $settings, $selectedDateUID*/
    4066) {
      $:
        buildMonthGrid($currentDate, $weekStartDay, $viewMode, $showWeekNumbers, $dailyNotes, $weeklyNotes, $settings, $selectedDateUID);
    }
    if ($$self.$$.dirty & /*$weekStartDay, $showWeekNumbers*/
    34) {
      $:
...
var MonthView, MonthView_default;
...
function create_if_block_62(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    if (
      /*plugin*/
      ctx2[0].settings.showTaskIndicators && /*yearlyStats*/
      ctx2[4] && /*yearlyStats*/
      ctx2[4].total > 0
    )
  ...
  return {
    c() {
      ...
      if (if_block)
        if_block.c();
      attr(span, "class", "yearly-label");
      attr(div, "class", "mix-calendar-yearly-row");
      attr(div, "role", "button");
      attr(div, "tabindex", "0");
    },
    m(target, anchor) {
...
function create_if_block_82(ctx) {
  ...
  return {
    c() {
      span = element("span");
      attr(span, "class", "mix-calendar-dot");
...
function create_if_block_72(ctx) {
  ...
  return {
    c() {
      ...
      t1 = text("/");
      t2 = text(t2_value);
      attr(span, "class", "yearly-task-count");
      toggle_class(
        span,
        "complete",
        /*yearlyStats*/
        ctx[4].completed === /*yearlyStats*/
        ctx[4].total
      );
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*yearlyStats*/
      16 && t0_value !== (t0_value = /*yearlyStats*/
      ctx2[4].completed + ""))
        set_data(t0, t0_value);
      if (dirty[0] & /*yearlyStats*/
      16 && t2_value !== (t2_value = /*yearlyStats*/
      ctx2[4].total + ""))
        set_data(t2, t2_value);
      if (dirty[0] & /*yearlyStats*/
      16) {
...
function create_if_block_23(ctx) {
  ...
  return {
    c() {
      div = element("div");
      div.innerHTML = `<span class="mix-calendar-dot"></span>`;
      attr(div, "class", "mix-calendar-dots");
    },
    m(target, anchor) {
      insert(target, div, anchor);
...
function create_if_block_14(ctx) {
  ...
  return {
    c() {
      div = element("div");
      span = element("span");
      attr(span, "class", "mix-calendar-task-dot");
      toggle_class(
        span,
        "complete",
        /*monthData*/
        ctx[30].taskStats.completed === /*monthData*/
        ctx[30].taskStats.total
      );
      toggle_class(
        span,
        "incomplete",
    ...
    p(ctx2, dirty) {
      ...
      2) {
        toggle_class(
          ...
          "complete",
          /*monthData*/
          ctx2[30].taskStats.completed === /*monthData*/
          ctx2[30].taskStats.total
        );
      }
      if (dirty[0] & /*quarters*/
      2) {
...
function create_if_block5(ctx) {
  ...
  let t0_value = (
    /*monthData*/
    ctx[30].dailyAggregate.completed + ""
  );
  let t0;
  let t1;
  let t2_value = (
    /*monthData*/
    ctx[30].dailyAggregate.total + ""
  );
  let t2;
  return {
    c() {
      ...
      t1 = text("/");
      t2 = text(t2_value);
      attr(span, "class", "month-daily-task-count");
      toggle_class(
        span,
        "complete",
        /*monthData*/
        ctx[30].dailyAggregate.completed === /*monthData*/
        ctx[30].dailyAggregate.total
      );
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*quarters*/
      2 && t0_value !== (t0_value = /*monthData*/
      ctx2[30].dailyAggregate.completed + ""))
        set_data(t0, t0_value);
      if (dirty[0] & /*quarters*/
      2 && t2_value !== (t2_value = /*monthData*/
      ctx2[30].dailyAggregate.total + ""))
        set_data(t2, t2_value);
      if (dirty[0] & /*quarters*/
      2) {
        toggle_class(
          ...
          "complete",
          /*monthData*/
          ctx2[30].dailyAggregate.completed === /*monthData*/
          ctx2[30].dailyAggregate.total
        );
      }
    },
...
function create_each_block_12(ctx) {
  ...
  let if_block0 = (
    /*monthData*/
    ctx[30].lunarLabel && create_if_block_42(ctx)
  );
  let if_block1 = (
    /*monthData*/
    ctx[30].lunarText && create_if_block_32(ctx)
  );
  function select_block_type_1(ctx2, dirty) {
    if (
      /*plugin*/
      ctx2[0].settings.showTaskIndicators && /*monthData*/
      ctx2[30].taskStats && /*monthData*/
      ctx2[30].taskStats.total > 0
    )
  ...
  let if_block3 = (
    /*plugin*/
    ctx[0].settings.showTaskIndicators && /*monthData*/
    ctx[30].dailyAggregate.total > 0 && create_if_block5(ctx)
  );
  ...
  return {
    c() {
      ...
      if (if_block3)
        if_block3.c();
      t5 = space();
      attr(span, "class", "month-gregorian");
      attr(div, "class", "mix-calendar-month-cell");
      attr(div, "role", "button");
      attr(div, "tabindex", "0");
      attr(div, "title", div_title_value = /*plugin*/
      ctx[0].settings.monthly.enabled ? "\u70B9\u51FB\u6253\u5F00\u6708\u8BB0 | Ctrl+Click \u65B0\u5206\u680F | \u53CC\u51FB\u8DF3\u8F6C\u6708\u89C6\u56FE" : "\u70B9\u51FB\u8DF3\u8F6C\u6708\u89C6\u56FE");
      toggle_class(
        div,
        "is-past",
        /*monthData*/
        ctx[30].isPast && /*plugin*/
        ctx[0].settings.pastTimeTransparent
      );
    },
    m(target, anchor) {
      insert(target, div, anchor);
    ...
    p(new_ctx, dirty) {
      ...
      if (
        /*plugin*/
        ctx[0].settings.showTaskIndicators && /*monthData*/
        ctx[30].dailyAggregate.total > 0
      ) {
        if (if_block3) {
          if_block3.p(ctx, dirty);
        } else {
          if_block3 = create_if_block5(ctx);
          if_block3.c();
          if_block3.m(div, t5);
        }
      } else if (if_block3) {
      ...
      if (dirty[0] & /*plugin*/
      1 && div_title_value !== (div_title_value = /*plugin*/
      ctx[0].settings.monthly.enabled ? "\u70B9\u51FB\u6253\u5F00\u6708\u8BB0 | Ctrl+Click \u65B0\u5206\u680F | \u53CC\u51FB\u8DF3\u8F6C\u6708\u89C6\u56FE" : "\u70B9\u51FB\u8DF3\u8F6C\u6708\u89C6\u56FE")) {
        attr(div, "title", div_title_value);
      }
      if (dirty[0] & /*quarters, plugin*/
      3) {
        toggle_class(
          div,
          "is-past",
...
function create_each_block3(ctx) {
  ...
  let if_block = (
    /*quarter*/
    ctx[27].hasQuarterlyNote && create_if_block_52(ctx)
  );
  ...
  return {
    c() {
      ...
      t3 = space();
      attr(div0, "class", "mix-calendar-quarter-label");
      attr(div0, "role", "button");
      attr(div0, "tabindex", "0");
      attr(div1, "class", "mix-calendar-quarter-months");
      attr(div2, "class", "mix-calendar-quarter-row");
    },
    m(target, anchor) {
    ...
    p(new_ctx, dirty) {
      ctx = new_ctx;
      if (dirty[0] & /*quarters*/
      2 && t0_value !== (t0_value = /*quarter*/
      ctx[27].label + ""))
        set_data(t0, t0_value);
      if (
        /*quarter*/
        ctx[27].hasQuarterlyNote
      ) {
        if (if_block) {
        } else {
      ...
      if (dirty[0] & /*plugin, quarters, handleMonthClick, navigateToMonthView, handleMonthContextMenu*/
      451) {
        each_value_1 = ensure_array_like(
          /*quarter*/
          ctx[27].months
...
function create_fragment5(ctx) {
  ...
  let if_block = (
    /*plugin*/
    ctx[0].settings.yearly.enabled && create_if_block_62(ctx)
  );
  let each_value = ensure_array_like(
    /*quarters*/
    ctx[1]
  ...
  return {
    c() {
      ...
      attr(div, "class", "mix-calendar-year-grid");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      if (if_block)
    ...
    p(ctx2, dirty) {
      if (
        /*plugin*/
        ctx2[0].settings.yearly.enabled
      ) {
        if (if_block) {
          if_block.p(ctx2, dirty);
        } else {
      ...
      if (dirty[0] & /*quarters, plugin, handleMonthClick, navigateToMonthView, handleMonthContextMenu, handleQuarterClick*/
      1475) {
        each_value = ensure_array_like(
          /*quarters*/
          ctx2[1]
...
function buildDailyAggregates(year, dailyNotesData) {
  const map = /* @__PURE__ */ new Map();
  const yearPrefix = `${year}-`;
  for (const [uid, stats] of Object.entries(dailyNotesData.taskStats)) {
    if (!uid.startsWith(yearPrefix))
      continue;
...
function isModPressed3(e) {
  return isMacOS3() ? e.metaKey : e.ctrlKey;
}
function instance5($$self, $$props, $$invalidate) {
  ...
  let $yearlyNotes;
  component_subscribe($$self, currentDate, ($$value) => $$invalidate(13, $currentDate = $$value));
  component_subscribe($$self, viewMode, ($$value) => $$invalidate(24, $viewMode = $$value));
  component_subscribe($$self, i18n, ($$value) => $$invalidate(2, $i18n = $$value));
  component_subscribe($$self, dailyNotes, ($$value) => $$invalidate(14, $dailyNotes = $$value));
  component_subscribe($$self, quarterlyNotes, ($$value) => $$invalidate(15, $quarterlyNotes = $$value));
  component_subscribe($$self, monthlyNotes, ($$value) => $$invalidate(16, $monthlyNotes = $$value));
  component_subscribe($$self, settings, ($$value) => $$invalidate(17, $settings = $$value));
  component_subscribe($$self, yearlyNotes, ($$value) => $$invalidate(18, $yearlyNotes = $$value));
  let { plugin } = $$props;
  let quarters = [];
  let yearGridEl;
  let lastScrolledYear = null;
  onMount(() => {
  ...
  function scrollToCurrentQuarter() {
    ...
    const quarterIdx = currentMonth <= 3 ? 0 : currentMonth <= 6 ? 1 : currentMonth <= 9 ? 2 : 3;
    const row = yearGridEl.querySelectorAll(".mix-calendar-quarter-row")[quarterIdx];
    if (row) {
      row.scrollIntoView({ behavior: "smooth", block: "start" });
    }
  }
  function buildYearGrid(date, pluginSettings, monthlyNoteData, quarterlyNoteData, dailyNotesData, quarterLabels) {
    if (!date)
      return;
    const year = date.year();
    const today = window.moment();
    ...
    const quarterDefs = [
      {
        months: [1, 2, 3],
        label: quarterLabels[0]
      },
      {
        months: [4, 5, 6],
        label: quarterLabels[1]
      },
      {
        months: [7, 8, 9],
        label: quarterLabels[2]
      },
      {
        months: [10, 11, 12],
        label: quarterLabels[3]
      }
    ];
    ...
    $$invalidate(1, quarters = result);
  }
  function navigateToMonthView(month) {
    set_store_value(viewMode, $viewMode = "month", $viewMode);
    set_store_value(currentDate, $currentDate = window.moment([$currentDate.year(), month - 1, 1]), $currentDate);
  }
  async function handleMonthClick(e, mData) {
    const granSettings = plugin.settings.monthly;
    if (!granSettings.enabled) {
      navigateToMonthView(mData.month);
      return;
    }
    const useNewLeaf = isModPressed3(e);
    ...
    const doCreate = async () => {
      const file = await createPeriodicNote(plugin.app, mData.refDate, "monthly", granSettings, plugin.settings.holidayOverrides);
      if (file)
        plugin.app.workspace.getLeaf(useNewLeaf ? "split" : false).openFile(file);
    };
    if (plugin.settings.shouldConfirmBeforeCreate) {
  ...
  async function handleMonthContextMenu(e, mData) {
    const existing = monthlyNotes.get(mData.dateUID);
    if (!existing)
      return;
    e.preventDefault();
  ...
  async function handleYearClick() {
    ...
    const doCreate = async () => {
      const file = await createPeriodicNote(plugin.app, refDate, "yearly", granSettings, plugin.settings.holidayOverrides);
      if (file)
  ...
  async function handleQuarterClick(quarter) {
    ...
    const notePath = getNotePath(refDate, granSettings);
    const doCreate = async () => {
      const file = await createPeriodicNote(plugin.app, refDate, "quarterly", granSettings, plugin.settings.holidayOverrides);
      if (file)
        plugin.app.workspace.getLeaf(false).openFile(file);
    };
    new ConfirmCreateModal(plugin.app, notePath, "\u5B63\u8BB0", doCreate).open();
  }
  const click_handler = (quarter) => handleQuarterClick(quarter);
  const click_handler_1 = (monthData, e) => handleMonthClick(e, monthData);
  const dblclick_handler = (monthData) => navigateToMonthView(monthData.month);
  const contextmenu_handler = (monthData, e) => handleMonthContextMenu(e, monthData);
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      yearGridEl = $$value;
      $$invalidate(3, yearGridEl);
    });
  }
  $$self.$$set = ($$props2) => {
    if ("plugin" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    8192) {
      $:
        $$invalidate(12, yearUID = $currentDate ? `${$currentDate.year()}` : "");
    }
    if ($$self.$$.dirty[0] & /*$settings, $yearlyNotes, yearUID*/
    397312) {
      $:
        $$invalidate(5, hasYearlyNote = $settings.yearly.enabled && !!$yearlyNotes.notes[yearUID]);
    }
    if ($$self.$$.dirty[0] & /*$settings, $yearlyNotes, yearUID*/
    397312) {
      $:
        $$invalidate(4, yearlyStats = $settings.yearly.enabled ? $yearlyNotes.taskStats[yearUID] ?? null : null);
    }
    if ($$self.$$.dirty[0] & /*$currentDate, $settings, $monthlyNotes, $quarterlyNotes, $dailyNotes, $i18n*/
    253956) {
      $:
        buildYearGrid($currentDate, $settings, $monthlyNotes, $quarterlyNotes, $dailyNotes, $i18n.quarters);
    }
    if ($$self.$$.dirty[0] & /*quarters, $currentDate, lastScrolledYear*/
    10242) {
      $:
        if (quarters.length > 0 && $currentDate) {
          const yr = $currentDate.year();
          if (lastScrolledYear !== yr) {
            $$invalidate(11, lastScrolledYear = yr);
...
var init_YearView = __esm({
  "src/calendar/YearView.svelte"() {
    ...
    init_fileMenu();
    init_converter();
    YearView = class extends SvelteComponent {
      constructor(options) {
        super();
        init(this, options, instance5, create_fragment5, safe_not_equal, { plugin: 0 }, null, [-1, -1]);
      }
    };
    YearView_default = YearView;
  }
});

// src/calendar/App.svelte
var App_exports = {};
...
function create_else_block2(ctx) {
  let yearview;
  let current;
  yearview = new YearView_default({ props: { plugin: (
    /*plugin*/
    ctx[0]
  ) } });
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*plugin*/
      1)
        yearview_changes.plugin = /*plugin*/
        ctx2[0];
...
function create_if_block6(ctx) {
  let monthview;
  let current;
  monthview = new MonthView_default({ props: { plugin: (
    /*plugin*/
    ctx[0]
  ) } });
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*plugin*/
      1)
        monthview_changes.plugin = /*plugin*/
        ctx2[0];
...
function create_fragment6(ctx) {
  ...
  return {
    c() {
      ...
      t = space();
      if_block.c();
      attr(div, "class", "mix-calendar-container");
      set_style(
        div,
        "--mix-task-dot-size",
        /*taskDotSize*/
...
function instance6($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, viewMode, ($$value) => $$invalidate(5, $viewMode = $$value));
  let { plugin } = $$props;
  $$self.$$set = ($$props2) => {
    if ("plugin" in $$props2)
      $$invalidate(0, plugin = $$props2.plugin);
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*$viewMode*/
    32) {
      $:
        $$invalidate(3, showMonthView = $viewMode === "month");
    }
    if ($$self.$$.dirty & /*$settings*/
    16) {
      $:
        $$invalidate(2, taskDotSize = $settings.taskDotSize ?? 9);
    }
    if ($$self.$$.dirty & /*$settings*/
    16) {
      $:
        $$invalidate(1, linkDotSize = $settings.linkDotSize ?? 5);
    }
  };
  return [plugin, linkDotSize, taskDotSize, showMonthView, $settings, $viewMode];
}
var App4, App_default;
var init_App = __esm({
  "src/calendar/App.svelte"() {
    "use strict";
    init_internal();
    ...
    init_YearView();
    init_stores();
    App4 = class extends SvelteComponent {
      constructor(options) {
        super();
...
__export(main_exports, {
  default: () => MixCalendarPlugin
});
module.exports = __toCommonJS(main_exports);
var import_obsidian6 = require("obsidian");
init_store();

// src/calendar/CalendarView.ts
...
var CalendarView = class extends import_obsidian4.ItemView {
  ...
  async onOpen() {
    ...
    const { default: App6 } = await Promise.resolve().then(() => (init_App(), App_exports));
    this.appComponent = new App6({
      target: container,
      props: {
        plugin: this.plugin
      }
  ...
  applyCustomCssClasses(container) {
  ...
  handleKeyDown(e) {
    ...
    if (tag === "INPUT" || tag === "TEXTAREA")
      return;
    const mode = get_store_value(viewMode);
    switch (e.key) {
      case "ArrowLeft":
        if (mode === "month") {
...
var MixCalendarSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(containerEl).setName("\u6BCF\u5468\u8D77\u59CB\u65E5 (Week Start)").setDesc("\u9009\u62E9\u65E5\u5386\u6BCF\u5468\u7684\u7B2C\u4E00\u5929").addDropdown((dropdown) => {
      dropdown.addOption("locale", "\u7CFB\u7EDF\u9ED8\u8BA4 (Locale)").addOption("sunday", "\u5468\u65E5 (Sunday)").addOption("monday", "\u5468\u4E00 (Monday)").setValue(this.plugin.settings.weekStart).onChange(async (value) => {
        this.plugin.settings.weekStart = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u754C\u9762\u8BED\u8A00 (UI Language)").setDesc("\u65E5\u5386\u63A7\u4EF6\u7684\u663E\u793A\u8BED\u8A00").addDropdown((dropdown) => {
      dropdown.addOption("zh", "\u4E2D\u6587").addOption("en", "English").setValue(this.plugin.settings.uiLocale || "zh").onChange(async (value) => {
        this.plugin.settings.uiLocale = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u672C\u5730\u5316\u8986\u76D6 (Locale Override)").setDesc("\u8986\u76D6 moment.js \u7684\u5730\u533A\u8BBE\u7F6E\uFF0C\u5F71\u54CD\u6BCF\u5468\u8D77\u59CB\u65E5\u3002\u9009\u62E9\u300C\u7CFB\u7EDF\u9ED8\u8BA4\u300D\u5219\u8DDF\u968F Obsidian \u8BED\u8A00\u3002").addDropdown((dropdown) => {
      dropdown.addOption("system-default", "\u7CFB\u7EDF\u9ED8\u8BA4 (System Default)").addOption("zh-cn", "\u7B80\u4F53\u4E2D\u6587 (zh-cn)").addOption("zh-tw", "\u7E41\u9AD4\u4E2D\u6587 (zh-tw)").addOption("en-us", "English (US)").addOption("en-gb", "English (UK)").addOption("ja-jp", "\u65E5\u672C\u8A9E").addOption("ko-kr", "\uD55C\uAD6D\uC5B4").setValue(this.plugin.settings.localeOverride || "system-default").onChange(async (value) => {
        this.plugin.settings.localeOverride = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u521B\u5EFA\u524D\u786E\u8BA4 (Confirm Before Create)").setDesc("\u70B9\u51FB\u4E0D\u5B58\u5728\u7684\u7B14\u8BB0\u65F6\u5F39\u51FA\u786E\u8BA4\u6846\uFF0C\u5173\u95ED\u5219\u76F4\u63A5\u521B\u5EFA").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.shouldConfirmBeforeCreate).onChange(async (value) => {
        this.plugin.settings.shouldConfirmBeforeCreate = value;
        await this.plugin.saveSettings();
      });
    });
    containerEl.createEl("h3", { text: "\u663E\u793A\u8BBE\u7F6E (Appearance)" });
    new import_obsidian5.Setting(containerEl).setName("\u519C\u5386\u4FE1\u606F (Show Lunar Info)").setDesc("\u5728\u65E5\u671F\u5355\u5143\u683C\u4E0B\u65B9\u663E\u793A\u519C\u5386/\u8282\u6C14/\u8282\u65E5").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showLunarInfo).onChange(async (value) => {
        this.plugin.settings.showLunarInfo = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u4F11/\u73ED\u6807\u8BB0 (Show Holiday Badges)").setDesc("\u663E\u793A\u6CD5\u5B9A\u8282\u5047\u65E5\u300C\u4F11\u300D\u548C\u8C03\u4F11\u4E0A\u73ED\u300C\u73ED\u300D\u7684\u89D2\u6807").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showHolidayBadges).onChange(async (value) => {
        this.plugin.settings.showHolidayBadges = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u5468\u6570\u663E\u793A (Show Week Numbers)").setDesc("\u5728\u6708\u89C6\u56FE\u5DE6\u4FA7\u663E\u793A ISO \u5468\u6570").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showWeekNumbers).onChange(async (value) => {
        this.plugin.settings.showWeekNumbers = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u8FC7\u53BB\u65E5\u671F\u534A\u900F\u660E (Past Date Transparent)").setDesc("\u5C06\u8FC7\u53BB\u65E5\u671F\u7684\u5355\u5143\u683C\u534A\u900F\u660E\u663E\u793A").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.pastTimeTransparent).onChange(async (value) => {
        this.plugin.settings.pastTimeTransparent = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u4EFB\u52A1\u5B8C\u6210\u6307\u793A (Show Task Indicators)").setDesc("\u5728\u65E5\u5386\u5355\u5143\u683C\u4E2D\u663E\u793A\u7B14\u8BB0\u5185\u4EFB\u52A1\u590D\u9009\u6846\u7684\u5B8C\u6210\u72B6\u6001\uFF08\u5B9E\u5FC3=\u5168\u90E8\u5B8C\u6210\uFF0C\u7A7A\u5FC3=\u6709\u5F85\u529E\uFF09").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showTaskIndicators).onChange(async (value) => {
        this.plugin.settings.showTaskIndicators = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u663E\u793A\u94FE\u63A5\u6570 (Show Link Count)").setDesc("\u5728\u65E5\u671F\u5355\u5143\u683C\u53F3\u4E0B\u89D2\u663E\u793A\u53CD\u5411\u94FE\u63A5\u6570\u91CF\uFF08\u9700\u542F\u7528\u540E\u7B49\u5F85\u4E0B\u6B21\u7D22\u5F15\uFF0C\u4EC5\u5BF9\u65E5\u8BB0\u751F\u6548\uFF09").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showLinkCount).onChange(async (value) => {
        this.plugin.settings.showLinkCount = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u4EFB\u52A1\u5706\u70B9\u5927\u5C0F (Task Dot Size)").setDesc("\u8C03\u6574\u4EFB\u52A1\u5B8C\u6210\u72B6\u6001\u5706\u70B9\u7684\u76F4\u5F84\uFF08\u50CF\u7D20\uFF09\uFF0C\u9ED8\u8BA4 9px").addSlider((slider) => {
      slider.setLimits(4, 20, 1).setValue(this.plugin.settings.taskDotSize ?? 9).setDynamicTooltip().onChange(async (value) => {
        this.plugin.settings.taskDotSize = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u94FE\u63A5\u5706\u70B9\u5927\u5C0F (Link Dot Size)").setDesc("\u8C03\u6574\u53CD\u5411\u94FE\u63A5\u5706\u70B9\u7684\u76F4\u5F84\uFF08\u50CF\u7D20\uFF09\uFF0C\u9ED8\u8BA4 5px").addSlider((slider) => {
      slider.setLimits(2, 12, 1).setValue(this.plugin.settings.linkDotSize ?? 5).setDynamicTooltip().onChange(async (value) => {
        this.plugin.settings.linkDotSize = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u81EA\u5B9A\u4E49 CSS \u7C7B (Custom CSS Classes)").setDesc("\u7A7A\u683C\u5206\u9694\u7684 CSS class \u540D\uFF0C\u4F1A\u6CE8\u5165\u5230\u65E5\u5386\u5BB9\u5668\u4E0A\uFF0C\u53EF\u7528\u4E8E\u81EA\u5B9A\u4E49\u6837\u5F0F\u3002").addText((text2) => {
      text2.setPlaceholder("my-custom-theme compact-mode").setValue(this.plugin.settings.customCssClasses || "").onChange(async (value) => {
    ...
    const lines = Object.entries(overrides).map(([date, type]) => `${date}:${type === "holiday" ? "\u4F11" : "\u73ED"}`).sort().join("\n");
    ...
    saveBtn.onclick = async () => {
      ...
      if (raw) {
        for (const line of raw.split("\n")) {
          ...
          if (/^\d{4}-\d{2}-\d{2}$/.test(date) && (type === "\u4F11" || type === "\u73ED")) {
  ...
  addGranularitySettings(containerEl, gran, label) {
    const settings2 = this.plugin.settings[gran];
    containerEl.createEl("h4", { text: label });
    new import_obsidian5.Setting(containerEl).setName("\u542F\u7528 (Enabled)").addToggle((toggle) => {
      toggle.setValue(settings2.enabled).onChange(async (value) => {
        this.plugin.settings[gran].enabled = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u65E5\u671F\u683C\u5F0F (Date Format)").setDesc("moment.js \u683C\u5F0F\u5B57\u7B26\u4E32\uFF0C\u7528\u4E8E\u751F\u6210\u6587\u4EF6\u540D").addText((text2) => {
      text2.setPlaceholder("YYYY/YYYY-MM/YYYY-MM-DD").setValue(settings2.format).onChange(async (value) => {
        this.plugin.settings[gran].format = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u6587\u4EF6\u5939\u8DEF\u5F84 (Folder)").setDesc("\u7B14\u8BB0\u5728 vault \u5185\u7684\u5B58\u653E\u8DEF\u5F84").addText((text2) => {
      text2.setPlaceholder("01-Daily").setValue(settings2.folder).onChange(async (value) => {
        this.plugin.settings[gran].folder = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(containerEl).setName("\u6A21\u677F\u8DEF\u5F84 (Template)").setDesc("\u7B14\u8BB0\u6A21\u677F\u6587\u4EF6\u8DEF\u5F84\uFF0C\u7559\u7A7A\u5219\u4E0D\u4F7F\u7528\u6A21\u677F").addText((text2) => {
      text2.setPlaceholder("Templates/Daily.md").setValue(settings2.template).onChange(async (value) => {
...
init_constants();
init_stores();
var MixCalendarPlugin = class extends import_obsidian6.Plugin {
  constructor() {
    super(...arguments);
    // ============================================================
  ...
  async migrateSettings() {
    ...
    try {
      ...
      if (dailyNotesPlugin?.instance?.options) {
        ...
        if (opts.format)
          this.settings.daily.format = opts.format;
        if (opts.folder)
          this.settings.daily.folder = opts.folder;
        if (opts.template)
          this.settings.daily.template = opts.template;
      ...
      if (calendarPlugin?.options) {
        ...
        if (opts.weekStart)
          this.settings.weekStart = opts.weekStart;
        if (opts.localeOverride)
          this.settings.localeOverride = opts.localeOverride;
        if (opts.shouldConfirmBeforeCreate !== void 0) {
          this.settings.shouldConfirmBeforeCreate = opts.shouldConfirmBeforeCreate;
        }
        if (opts.showWeeklyNote !== void 0) {
          this.settings.weekly.enabled = opts.showWeeklyNote;
        }
        if (opts.weeklyNoteFormat)
          this.settings.weekly.format = opts.weeklyNoteFormat;
        if (opts.weeklyNoteFolder)
          this.settings.weekly.folder = opts.weeklyNoteFolder;
        if (opts.weeklyNoteTemplate)
          this.settings.weekly.template = opts.weeklyNoteTemplate;
        console.log("[Mix Calendar] Migrated settings from Calendar plugin");
      }
      const chinesePlugin = this.app.plugins?.getPlugin?.("chinese-calendar");
      if (chinesePlugin?.settings) {
        const opts = chinesePlugin.settings;
        if (opts.appearance?.pastTimeTransparent !== void 0) {
  ...
  async indexGranularity(gran) {
    const granSettings = this.settings[gran];
    if (!granSettings.enabled || !granSettings.folder)
      return;
    const store = noteStores[gran];
    try {
      ...
      const linkCounts = gran === "daily" && this.settings.showLinkCount ? this.computeLinkCounts(matchingFiles) : {};
      console.log(
        `[Mix Calendar] Indexed ${gran}: ${Object.keys(notes).length} notes, ${Object.keys(taskStats).length} with tasks, ${Object.keys(linkCounts).length} with backlinks`
      );
      store.set({ notes, taskStats, linkCounts, lastIndexed: Date.now() });
    } catch (err) {
  ...
  async computeTaskStats(matchingFiles, _gran) {
    const taskStats = {};
    await Promise.all(
   ...
   */
  computeLinkCounts(matchingFiles) {
    const linkCounts = {};
    const pathToUID = {};
    ...
    console.log(
      `[Mix Calendar] Computed link counts: ${Object.keys(linkCounts).length} daily notes have backlinks (resolvedLinks available: ${!!resolvedLinks})`
    );
    return linkCounts;
  }
  // ============================================================
  ...
  scheduleBacklinkRefresh() {
    if (!this.settings.showLinkCount)
      return;
    if (this.backlinkDebounceTimer)
      clearTimeout(this.backlinkDebounceTimer);
  ...
  refreshDailyBacklinks() {
    if (!this.settings.daily.enabled || !this.settings.showLinkCount)
      return;
    const store = noteStores["daily"];
    const data = get_store_value(store);
